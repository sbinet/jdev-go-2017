...
`jdev-go-2017` is a simple repository holding sources for the `Go`
hands-on session of the [JDEV-2017](https://jdev2017.fr).

The slides are [here](https://talks.godoc.org/github.com/sbinet/jdev-go-2017/talk.slide).
...
```sh
$ go get -u -v github.com/sbinet/jdev-go-2017/cmd/jdev-hello
github.com/sbinet/jdev-go-2017 (download)
```

`go get` downloaded (cloned, in `git` speak) the whole
`github.com/sbinet/jdev-go-2017` repository (under `$GOPATH/src`) and
